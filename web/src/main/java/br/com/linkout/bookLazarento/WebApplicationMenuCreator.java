package br.com.linkout.bookLazarento;

import br.com.linkout.bookLazarento.pages.AlterarSenhaPage;
import br.com.linkout.bookLazarento.pages.CrudUsuarioPage;
import br.com.linkout.bookLazarento.pages.livros.NovoLivroPage;
...
public class WebApplicationMenuCreator extends AbstractMenuConfigFactoryBean {
    ...
    protected MenuConfig createMenuConfig() {
        ...
        // add menu here
        config.addPage(NovoLivroPage.class, "Livro", "Incluir Livro");
